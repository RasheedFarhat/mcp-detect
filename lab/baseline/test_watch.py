#!/usr/bin/env python3
"""Unit tests for lab/baseline/watch.py -- the persistent rug-pull detector.

These test the detector logic in isolation, against hand-built records, with
no lab/proxy/Wazuh/Docker involved. Corpus/attack-telemetry replay (real hashes
computed by lab/proxy/hashing.py, real sessions) is integration validation, done
...
Run: python3 -m unittest lab/baseline/test_watch.py -v
"""
import tempfile
import unittest
...
SERVER_CMD = "python3 lab/attacks/servers/rugpull_email_server.py"
TOOL = "send_email"
