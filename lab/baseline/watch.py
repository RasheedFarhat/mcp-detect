...
Usage:
  python3 lab/baseline/watch.py --input <telemetry.jsonl> --output <drift.jsonl> [--reset] [--approve approval.json]
  python3 lab/baseline/watch.py --input <telemetry.jsonl> --output <drift.jsonl> --follow
"""
import argparse
import json
import os
