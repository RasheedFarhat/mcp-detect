...
Canonicalization recipe (see lab/schema/schema.md for the language-agnostic spec):
...
This must stay in lockstep with lab/schema/schema.md's prose description -- if you
