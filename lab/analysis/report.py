...
Usage:
  python3 lab/analysis/report.py                    generate docs/PHASE4-REPORT.md
  python3 lab/analysis/report.py --session <id>     print one session's reconstruction
  python3 lab/analysis/report.py --task-id <id>     print one task's reconstruction
...
def render_report(*, rule_sha: str, wazuh_version: str, inputs: dict,
    ...
    out = []
    out.append("<!-- GENERATED FILE -- produced by lab/analysis/report.py. Do not "
                "hand-edit; re-run `python3 lab/analysis/report.py` to update. -->")
    ...
    if cross_scenario:
        ...
        out.append("\n**Explanation, per `docs/PHASE3B-DESIGN.md`**: `lab/attacks/servers/"
    ...
    out.append("Generated by this tool's secondary mode "
                "(`python3 lab/analysis/report.py --task-id attack_credential_exfil_sandbox_bait`), "
