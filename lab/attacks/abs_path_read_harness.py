...
Same self-contained shape as lab/attacks/path_traversal_harness.py (no shared
import with the frozen lab/attacks/harness.py), same real pinned MCP filesystem
...
Usage: python3 lab/attacks/abs_path_read_harness.py --log-path <path>
