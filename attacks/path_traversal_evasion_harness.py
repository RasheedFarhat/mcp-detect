...
Deliberately NOT built on attacks/path_traversal_harness.py (that generates
the canonical corpus; kept separate the same way attacks/evasion_harness.py
is kept separate from attacks/harness.py) -- self-contained, same
...
Usage: python3 attacks/path_traversal_evasion_harness.py --log-path <scratch path>
"""
import argparse
import asyncio
import sys
