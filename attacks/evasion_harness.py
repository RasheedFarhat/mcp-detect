...
NOT built on attacks/harness.py (kept frozen so Phase 4's telemetry stays
...
(does the rule actually fire) is analysis/evasion_report.py's job, via a real
batch wazuh-logtest run, not asserted here.

Usage: python3 attacks/evasion_harness.py --log-path <scratch path> [--sink-url URL]
attacks/sink.py must already be running for the credential-exfil evasions
(E5-E9), same requirement attacks/harness.py has for the original attack.
"""
import argparse
import asyncio
import base64
...
# ---------------------------------------------------------------------------
# Rug pull evasions/probes (100201 / baseline/watch.py)
# ---------------------------------------------------------------------------
