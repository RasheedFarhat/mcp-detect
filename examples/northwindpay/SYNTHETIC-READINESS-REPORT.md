...
environment -- see the full technical report
([`audit_report_run.md`](audit_report_run.md)) for those numbers in detail.
...
- Full technical report (raw tool output, unedited):
  [`audit_report_run.md`](audit_report_run.md)
- AI-BOM + shadow-server diff, machine-readable:
  [`audit_report_run.json`](audit_report_run.json)
- This assessment's own validation against a sealed ground-truth manifest
  (recall/false-finding/honesty scoring):
  [`ASSESSMENT-VALIDATION.md`](ASSESSMENT-VALIDATION.md)
