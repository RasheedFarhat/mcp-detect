...
v2 addition: a cluster of filesystem tasks under corpus/fixtures/ deliberately
...
corpus/fixtures/README.md and the comments in each fixture file for why each
one is safe -- nothing under corpus/fixtures/ is a real secret. Verified
non-matching against the actual rule pattern before use (docs/PHASE1b.md).

Each task dict may set "repeat": N to weight how many times corpus/agent.py
...
TASKS = [
    ...
    },
    {
        ...
        "server_command": ["npx", "-y", "@modelcontextprotocol/server-filesystem@2026.7.4", WORKSPACE],
        "prompt": (
            "Read the file schema/schema.md and tell me: what does the 'label' field "
    ...
    },
    {
        ...
        "server_command": ["npx", "-y", "@modelcontextprotocol/server-filesystem@2026.7.4", WORKSPACE],
        "prompt": "Read schema/schema.json and tell me what top-level fields are required.",
        "repeat": 12,
    },
    {
        "task_id": "fs_read_example_env_fixture",
        "server_command": ["npx", "-y", "@modelcontextprotocol/server-filesystem@2026.7.4", WORKSPACE],
        "prompt": "Read corpus/fixtures/example.env.txt and summarize what it contains.",
        "repeat": 12,
    },
    {
        "task_id": "fs_read_config_dir_settings",
        "server_command": ["npx", "-y", "@modelcontextprotocol/server-filesystem@2026.7.4", WORKSPACE],
        "prompt": "Read corpus/fixtures/config/app_settings.json and tell me what settings it defines.",
        "repeat": 12,
    },
    {
        "task_id": "fs_read_keys_dir_readme",
        "server_command": ["npx", "-y", "@modelcontextprotocol/server-filesystem@2026.7.4", WORKSPACE],
        "prompt": "Read corpus/fixtures/keys/keys_directory_readme.md and explain what it's about.",
        "repeat": 12,
    },
    ...
    # `agent.py --task-id <id> --repeat N`, not a full run -- see docs/PHASE1.md.
    {
        ...
        "server_command": ["npx", "-y", "@modelcontextprotocol/server-filesystem@2026.7.4", WORKSPACE],
        "prompt": "List the contents of the corpus/fixtures/ directory.",
    },
    {
