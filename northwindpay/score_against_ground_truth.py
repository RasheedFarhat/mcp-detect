#!/usr/bin/env python3
"""Scores a framework/audit_report.py JSON run against northwindpay/GROUND_TRUTH.json.

This is the ONLY script in this directory that reads GROUND_TRUTH.json -- the
assessment run itself (framework/audit_report.py northwindpay/telemetry.jsonl
--known-good northwindpay/known_good_bom.json) never does, and never can:
